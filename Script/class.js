...
const s014 = ["Horizon", "Guerrilla Games et Sony Interactive Entertainment"];
const s015 = ["Dragon Quest", "Square Enix"];
const s016 = ["NieR", "Square Enix"];
const s017 = ["Valorant", "Riot Games"];
const s018 = ["Elden Ring", "FromSoftware et Bandai Namco Entertainment"];
...
const s028 = ["Clair Obscur: Expedition 33", "Sandfall Interactive et Kepler Interactive"];
const s029 = ["Balatro", "LocalThunk et Playstack"];
const s030 = ["Geometry Dash", "RobTop"];
const s031 = ["Monster Hunter", "Capcom"];
const s032 = ["Minecraft", "Mojang"];
const s033 = ["Xenoblade Chronicles", "Monolith Soft et Nintendo"];
const s034 = ["Overwatch", "Blizzard Entertainment"];
const s035 = ["Heartstone", "Blizzard Entertainment"];
const s036 = ["Rayman", "Ubisoft"];
const s037 = ["Persona", "Atlus"];
const s038 = ["Terraria", "Re-Logic"];
const s039 = ["Umamusume: Pretty Derby", "Cygames"];
const s040 = ["Tetris", "The Tetris Company"] ;
const s041 = ["Grand Theft Auto", "Take-Two Interactive et Rockstar Games"];
const s042 = ["Pokemon", "Game Freak et Nintendo"];
const s043 = ["Wii Sports", "Nintendo"];
const s044 = ["The Sims", "Maxis et Electronic Arts"];
const s045 = ["Animal Crossing", "Nintendo"];
const s046 = ["Call of Duty", "Activision"];
const s047 = ["The Legend of Zelda", "Nintendo"];
const s048 = ["Cyberpunk 2077", "CD Projekt RED"];
const s049 = ["The Elder Scrolls", "Bethesda Softworks"];
const s050 = ["Just Dance", "Ubisoft"];
const s051 = ["Halo", "Bungie, 343 Industries et Micros"];
const s052 = ["Metal Gear", "Konami"];
const s053 = ["Kirby", "HAL Laboratory et Nintendo"];
const s054 = ["Pac-Man", "Bandai Namco"];
const s055 = ["Punch-Out", "Nintendo"];
const s056 = ["Yoshi", "Nintendo"];
const s057 = ["Metroid", "Nintendo"];
const s058 = ["Splatoon", "Nintendo"];
const s059 = ["Donkey Kong", "Nintendo"];
const s060 = ["Mario & Luigi", "AlphaDream, Acquire et Nintendo"];
const s061 = ["Taiko no Tatsujin", "Bandai Namco"];
const s062 = ["Touhou Project", "Team Shanghai Alice (ZUN)"];
const s063 = ["Doki Doki Literature Club", "Team Salvato"];
const s064 = ["Resident Evil", "Capcom"];
const s065 = ["Fall Guys","Mediatonic, Devolver Digital et Epic Games"];
...
const j031 = ["Deltarune", s012, 2025];
...
const j048 = ["Super Mario 3D World", s002, 2013];
const j049 = ["Dark Souls 1", s023, 2011];
const j050 = ["Dark Souls 2", s023, 2014];
const j051 = ["Dark Souls 3", s023, 2016];
const j052 = ["Fortnite", s024, 2017];
const j053 = ["Rocket League", s025, 2015];
const j054 = ["Counter-Strike", s026, 2000];
const j055 = ["Counter-Strike: Source", s026, 2008];
const j056 = ["Counter-Strike: Global Offensive", s026, 2012];
const j057 = ["Hollow Knight", s027, 2017];
const j058 = ["Hollow Knight: Silksong", s027, 2025];
const j059 = ["Clair Obscur: Expedition 33", s028, 2025];
const j060 = ["Balatro", s029, 2024];
const j061 = ["Geometry Dash", s030, 2013];
const j062 = ["Monster Hunter: World", s031, 2018];
const j063 = ["Monster Hunter Wilds", s031, 2025];
const j064 = ["Minecraft", s032, 2011]
const j065 = ["Monster Hunter Rise", s031, 2021];
const j066 = ["Xenoblade Chronicles: Definitive Edition", s033, 2020];
const j067 = ["Xenoblade Chronicles 2", s033, 2018];
...
const j075 = ["Persona 5", s037, 2016];
const j076 = ["Umamusume: Pretty Derby", s039, 2021];
const j077 = ["Terraria", j038, 2011];
const j078 = ["Tetris (Game Boy)", s040, 1989];
const j079 = ["Tetris Worlds", s040, 2001];
const j080 = ["Tetris 99", s040, 2019];
const j081 = ["Tetris (NES)", s040, 1989];
const j082 = ["Puyo Puyo Tetris", s040, 2014];
const j083 = ["Grand Theft Auto III", s041, 2001];
const j084 = ["Grand Theft Auto: Vice City", s041, 2002];
const j085 = ["Grand Theft Auto: San Andreas", s041, 2004];
const j086 = ["Grand Theft Auto IV", s041, 2008];
const j087 = ["Grand Theft Auto V", s041, 2013];
const j088 = ["Pokémon Rouge/Bleu", s042, 1996];
const j089 = ["Pokémon Or/Argent", s042, 1999];
const j090 = ["Pokémon Rubis/Saphir", s042, 2002];
const j091 = ["Pokémon Diamant/Perle", s042, 2006];
const j092 = ["Pokémon Or HeartGold/Argent SoulSilver", s042, 2009];
const j093 = ["Pokémon Noir/Blanc", s042, 2010];
const j094 = ["Pokémon Noir 2/Blanc 2", s042, 2012];
const j095 = ["Pokémon X/Y", s042, 2013];
const j096 = ["Pokémon Rubis Oméga/Saphir Alpha", s042, 2014];
...
const t018 = ["t018", j060, "Screenshot", "Facile"];
...
export const mediumQuestion = [t001, t002, t003, t004, t005, t006]
